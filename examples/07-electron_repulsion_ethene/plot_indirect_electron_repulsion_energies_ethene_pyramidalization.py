...
if __name__ == "__main__":
    ...
    axes[1].legend(title="$\mathbf{(d)}$ off-diagonal", loc='lower right')
    ...
    plt.savefig("indirect_electron_repulsion_energies_ethene_pyramidalization.svg")
    #plt.savefig("indirect_electron_repulsion_energies_ethene_pyramidalization.png", dpi=300)
