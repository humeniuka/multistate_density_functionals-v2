...
if __name__ == "__main__":
    ...
    axes[1].legend(title="$\mathbf{(b)}$ off-diagonal", loc='upper right')
    ...
    plt.savefig("electron_repulsion_energies_ethene_cc_torsion.svg")
    plt.savefig("electron_repulsion_energies_ethene_cc_torsion.png", dpi=300)
